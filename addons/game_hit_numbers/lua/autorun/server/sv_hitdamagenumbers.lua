...
CreateConVar( "sv_hitnums_scale", 0.05 )
SetGlobalFloat( "HDN_Scale", 0.05 )
...
local font_outline = false

CreateConVar( "sv_hitnums_font_name", "Open Sans SemiBold" )
cvars.AddChangeCallback( "sv_hitnums_font_name", function()
	font_name = GetConVarString("sv_hitnums_font_name")
end )

CreateConVar( "sv_hitnums_font_size", 192 )
...
CreateConVar( "sv_hitnums_font_outline", 0 )

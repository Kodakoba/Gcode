GCompute.CodeEditor.KeyboardMap:Register (KEY_F,
...
GCompute.CodeEditor.KeyboardMap:Register (KEY_G,
	function (self, key, ctrl, shift, alt)
		if not ctrl then return false end
		...
		GCompute.OpenGoToDialog (
			function (line)
				...
				self:SetCaretPos (GCompute.CodeEditor.LineColumnLocation (line, 0))
			end
		)
	end
)
...
SWEP.PrintName = "KH-25PM"
SWEP.TrueName = "MP5A2"
SWEP.Trivia_Class = "Submachine Gun"
SWEP.Trivia_Desc = "With over 100 variants of the MP5, it's one of the most widely used submachine guns in the world. Favored by SWAT and Hostage Rescue Teams and security personnel across the globe."
...
SWEP.ViewModel = "models/weapons/arccw/dm1973/c_dmi_pms_mp5.mdl"
SWEP.WorldModel = "models/weapons/arccw/dm1973/w_dmi_pms_mp5.mdl"
...
SWEP.Attachments = {
	...
	{	--2
        ...
        Bone = "Weapon_Rotate",
        Offset = {
            vpos = Vector(0, -4.05, 18.2),
            vang = Angle(90, 0, -90),
            wpos = Vector(18.6, 0.68, -6.2),
	...
	{	--3
        ...
        SlideAmount = {
            vmin = Vector(0, -3, 9.3),
            vmax = Vector(0, -3, 15),
            wmin = Vector(13.8, 0.602, -4.3),
            wmax = Vector(13.8, 0.602, -4.3),
        },
    },
	{	--4
        PrintName = "Tactical",

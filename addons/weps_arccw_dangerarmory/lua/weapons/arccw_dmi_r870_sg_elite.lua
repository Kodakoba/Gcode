...
SWEP.ViewModel = "models/weapons/arccw/dm1973/c_dmi_r870sg_elite.mdl"
...
SWEP.ShootSound = "weapons/arccw/dmi_gunsdefense_2/590_1.wav"
SWEP.ShootSound = "weapons/arccw/dmi_gunsdefense_2/590_1.wav","weapons/arccw/dmi_gunsdefense_2/590_2.wav","weapons/arccw/dmi_gunsdefense_2/590_3.wav"
...
SWEP.IronSightStruct = {
    Pos = Vector(-3.6, 0, 0.159),
    Ang = Vector(0.977, 0.029, 0),
    Magnification = 1.1,
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Bone = "Weapon_Main",
        Offset = {
            vpos = Vector(0.071, -1.25, 19.8),
            vang = Angle(90, 0, -90),
            wpos = Vector(34, 0.71, -8.86),
    ...
    },
    {
        ...
        SlideAmount = {
            vmin = Vector(0, 0, -4),
            vmax = Vector(0, 0, 0),
            wmin = Vector(20, 0.832, -4.8),
            wmax = Vector(20, 0.832, -4.8),
        },	
    },
    {
        PrintName = "Tactical",

...
SWEP.MalfunctionMean = 56 -- The mean number of shots between malfunctions, will be autocalculated if nil
...
SWEP.Animations = {
    ...
    ["fix"] = {
		...
		SoundTable = {
        {s = "Firearms2.Cloth_Movement", t = 0},
        {s = "Firearms2.G3_Handle", t = 0.375},
        {s = "Firearms2.G3_BoltPullNomen", t = 0.47},
        {s = "Firearms2.Cloth_Movement", t = 0.47},
		},
    },
    ["reload"] = {
        Source = "reload",

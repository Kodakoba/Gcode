...
SWEP.Hook_TranslateAnimation = function(wep, anim)
    ...
    if wep.Attachments[5].Installed == "fas2_extra_foregrip" then return anim .. "_grip" end
...
SWEP.Hook_SelectReloadAnimation = function(wep, anim)
    ...
    if wep.Attachments[5].Installed == "fas2_extra_foregrip" then return anim .. "_grip" .. nomen end

...
SWEP.Hook_SelectInsertAnimation = function(wep, data)
    ...
    local insertsh = math.min(wep.Primary.ClipSize + wep:GetChamberSize() - wep:Clip1(), wep:GetOwner():GetAmmoCount(wep.Primary.Ammo), 4)
    local anim = "sgreload_insert" .. insertsh

    return {count = insertsh, anim = anim, empty = false}
end

...
hook.Add("PostDrawTranslucentRenderables", "mittyvis", function()
	...
	for k,v in pairs(Memes.Decals) do 
		local dist = lp:DistToSqr(v.PixPos or v.Pos)
...
hook.Add("PreDrawEffects", "mittypls", function(bd, bs)

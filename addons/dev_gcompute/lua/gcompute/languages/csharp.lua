...
LANGUAGE:GetKeywordClassifier ()
	...
	:AddKeywords (GCompute.Lexing.KeywordType.DataType, {"typedef", "static", "public", "private", "protected", "virtual", "override", "new"})
	:AddKeywords (GCompute.Lexing.KeywordType.DataType, {"unsigned", "signed"})
	:AddKeywords (GCompute.Lexing.KeywordType.DataType, {"void", "bool", "char", "short", "int", "long", "float", "double", "string"})

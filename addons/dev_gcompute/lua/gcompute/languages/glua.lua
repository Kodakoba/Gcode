...
LANGUAGE:GetKeywordClassifier ()
	:AddKeywords (GCompute.Lexing.KeywordType.Modifier, {"function", "local"})
	:AddKeywords (GCompute.Lexing.KeywordType.Control,  {"if", "then", "else", "elseif", "end", "while", "for", "in", "do", "break", "repeat", "until", "return"})
	:AddKeyword  (GCompute.Lexing.KeywordType.Control,   "continue")
	:AddKeywords (GCompute.Lexing.KeywordType.Operator, {"not", "and", "or"})
	:AddKeywords (GCompute.Lexing.KeywordType.Constant, {"true", "false", "nil"})

...
LANGUAGE:GetTokenizer ()
	...
	:AddPlainSymbols  (GCompute.Lexing.TokenType.Operator,            {"#", "!", "~", "+", "-", "^", "&", "|", "*", "/", "=", "<", ">", "(", ")", "{", "}", "[", "]", "%", "?", ":", ","})
	:AddPlainSymbols  (GCompute.Lexing.TokenType.Operator,            {"new", "delete"})
...
LANGUAGE:GetKeywordClassifier ()
	:AddKeywords (GCompute.Lexing.KeywordType.Control,  {"if", "else", "while", "for", "do", "break", "switch", "return", "continue"})
	:AddKeywords (GCompute.Lexing.KeywordType.DataType, {"namespace", "struct", "class", "enum", "union", "using"})
	:AddKeywords (GCompute.Lexing.KeywordType.DataType, {"typedef", "static", "public", "private", "protected", "virtual"})
	:AddKeywords (GCompute.Lexing.KeywordType.DataType, {"unsigned", "signed"})
	:AddKeywords (GCompute.Lexing.KeywordType.DataType, {"void", "bool", "char", "short", "int", "long", "float", "double"})
	:AddKeywords (GCompute.Lexing.KeywordType.Constant, {"true", "false", "this", "NULL"})

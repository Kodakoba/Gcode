...
LANGUAGE:GetKeywordClassifier ()
	:AddKeywords (GCompute.Lexing.KeywordType.Control,  {"if", "else", "while", "for", "do", "break", "switch", "new"})
	:AddKeywords (GCompute.Lexing.KeywordType.Modifier, {"public", "private", "protected", "friend", "static", "const"})
	:AddKeywords (GCompute.Lexing.KeywordType.DataType, {"namespace", "struct", "class", "enum", "using"})

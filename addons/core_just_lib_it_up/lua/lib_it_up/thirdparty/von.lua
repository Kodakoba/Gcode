...
--i trimmed some changelogs here

setfenv(1, _G)

local _deserialize, _serialize, _d_meta, _s_meta, d_findVariable, s_anyVariable
local sub, gsub, find, concat, error, tonumber, type, next = string.sub, string.gsub, string.find, table.concat, error, tonumber, type, next

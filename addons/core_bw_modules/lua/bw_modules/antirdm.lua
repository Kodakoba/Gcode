...
PLAYER.GetRespawnTime = (MODULE.GetRespawnTime)
...
hook.Add("PreDrawHalos", tag .. ".PreDrawHalos", (MODULE.PreDrawHalos))
]]
else
...
function MODULE.IsRDM(ply, ply2)
	...
	if ply.RecentlyHurtBy and ply.RecentlyHurtBy[ply2] and ply.RecentlyHurtBy[ply2] < CurTime() + BaseWars.Config.AntiRDM.HurtTime then return false end
...
PLAYER.CalculateSpawnTime = (MODULE.CalculateSpawnTime)
...
hook.Add("OnTakeDamage", tag .. ".TakeDamage", (MODULE.OnEntityTakeDamage))
...
hook.Add("PlayerDeath", tag .. ".PlayerDeath", (MODULE.PlayerDeath))
...
hook.Add("PlayerDeathThink", tag .. ".PlayerDeathThink", (MODULE.PlayerDeathThink))
...
hook.Add("PlayerInitialSpawn", tag .. ".PlayerInitialSpawn", (MODULE.PlayerInitialSpawn))

...
local core = (lanes_copy and lanes_copy.core) or lanes.core
lanes_copy = lanes_copy or lanes
...
lanes.configure = function( settings )
	...
	if not settings or settings.with_timers ~= false then
